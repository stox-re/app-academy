...
View.prototype.exercise3 = function () {
  ...
  //your code here!
  let appendingWith = $('<h1>i love jquery</h1>');
  $('#easel').append(appendingWith);
};
...
View.prototype.exercise4 = function () {
  ...
  //your code here!
  let squares = $('li.square:nth-child(even)').text('Michael');
};
