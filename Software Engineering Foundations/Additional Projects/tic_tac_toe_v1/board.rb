...
#    def position_empty_rescue
#        begin
#            raise "Error: This position is not empty."
#        rescue
#            puts "This position is not empty. Please only enter an empty position."
#            $game.current_player.get_position # This should call the Human_player.get_position
#            return
#        end
#    end
#
#    def position_valid_rescue
#        begin
#            raise "Error: This position is not valid."
#        rescue
#            puts "This position is not valid. Please only enter a valid position."
#            $game.current_player.get_position # This should gall the Human_player.get_position
#            return
#        end
#    end
